...
library(Lmoments)
library(moments)
library(goftest)#used for AD test
install.packages("nsRFA")
library(nsRFA)
install.packages("FAdist")#used for Mle mme for pearson 3 
library(FAdist) #used for ks.test for pearson3
...
data_TP <- read.csv("Tweed-Peebles.csv")
```
